...
> [v0.11.0](https://github.com/iamwavecut/mlx-maple-cuda-kernels/releases).
...
lane, **on by default** on every bit-proven profile (sm86/sm120 up to
B=8; RTX 4090 and H100 up to B=4, where their curves beat or match
stock — the 4090 measures +41% at B=1 and +23% at B=2 on a quiet
host): every
...
beats stock at every batch size (aggregate 853 vs 697 tok/s at B=4).
`MAPLE_BATCH_MEGAKERNELS=0/1` forces it; details and per-arch grid
tuning: [`docs/BATCH-MEGAKERNELS.md`](docs/BATCH-MEGAKERNELS.md).
...
- Provenance: [`src/maple.py`](src/maple.py) SHA-256
  `ed35978ad0574df4ef5f22a424cbc70b42b7fb4d2d72b211f9f061167cbaebb1`,
  patch SHA-256
  `a66bf601dc709c7f89c9cc0d407c54b885e821af6db45d56a3b319a26d715a6f`.
