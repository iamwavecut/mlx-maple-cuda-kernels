...
where measured faster — sm86/sm89 — and off elsewhere; every lane falls
back to portable MLX on any mismatch). Environment overrides:
`MAPLE_ATTENTION_MEGAKERNEL=0/1` forces the attention lane,
